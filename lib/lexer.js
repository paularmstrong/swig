 ...
 * @return {{match: string, type: number, length: number}}     Defined type, potentially stripped or replaced with more suitable content.
 * @api private
 */
function reader(str) {
  var matched;
 ...
 * @param  {string} str
 * @return {[{match: string, type: number, length: number}...]}     Array of defined types, potentially stripped or replaced with more suitable content.
 */
