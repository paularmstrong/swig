...
/**
 * Swig Options Object
 * @param {boolean} autoescape  Controls whether or not variable output will automatically be escaped for safe HTML output. Defaults to <code data-language="js">true</code>.
 * @param {array}   varControls Open and close controls for variables. Defaults to <code data-language="js">['{{', '}}']</code>.
 * @param {array}   tagControls Open and close controls for tags. Defaults to <code data-language="js">['{%', '%}']</code>.
 * @param {array}   cmtControls Open and close controls for comments. Defaults to <code data-language="js">['{#', '#}']</code>.
 * @param {object}  locals      Default variable context to be passed to <strong>all</strong> templates.
 * @param {(boolean|string|{get: Function, set: Function})} cache Cache control for templates. Defaults to saving in <code data-language="js">'memory'</code>. Send <code data-language="js">false</code> to disable. Send an object with <code data-language="js">get</code> and <code data-language="js">set</code> functions to customize.
 */
var defaultOptions = {
    autoescape: true,
    varControls: ['{{', '}}'],
...
exports.Swig = function (opts) {
   ...
   * @param  {boolean} ends     Whether or not this tag requires an <i>end</i> tag.
   * @return {undefined}
   * @api public
   */
