...
exports.Swig = function (opts) {
   ...
   * Inspired by Django's `simple_tag`, `setSimpleTag()` is a streamlined way to define
   * basic custom tags. These tags never use an end tag, nor do they work outside of a block.
   *
   * Note that only number/string/variable parameters are supported inside the tag,
   * and tag output is *not* escaped by default (although you can do this yourself
   * inside the tag's logic).
   *
   * @example
