...
exports.Swig = function (opts) {
  ...
  this.parse = function (source, options) {
    ...
    options = utils.extend({}, self.options, _.omit(options, 'locals'));
  ...
  this.compile = function (source, options) {
    ...
    tpl = new Function('_swig', '_ctx', '_filters', '_', 'utils', '_fn', [
      '  var _output = "";',
    ...
    function compiled(context) {
      return tpl(self, utils.extend(context || {}, locals), filters, _, utils, efn);
    }

    utils.extend(compiled, tokens);
