...
var defaultOptions = {
     ...
     */
    cache: 'memory',
    loader: new loaders.FileSystemLoader(null)
  },
  defaultInstance;
...
exports.Swig = function (opts) {
  ...
  this.parseFile = function (pathname, options) {
    ...
    pathname = self.options.loader.resolve(options.resolveFrom, pathname);
  ...
  function getParents(tokens, options) {
    ...
    while (parentName) {
      ...
      parentFile = self.options.loader.resolve(parentFile, parentName);
