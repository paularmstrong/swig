...
module.exports.tagFromSimpleTag = function (simpleTag) {
  var _tag = function (indent, parser) {
    var out = '',
      result = simpleTag(this.args);

    if (result) {
      // Escape result and add to output
