...
exports.compile = function compile(compiler, args) {
  ...
  utils.each(args, function eachArgs(arg) {
    var c = arg.compiled;
    utils.each(replacements, function eachReplacements(re) {
...
exports.parse = function parse(str, line, parser, types, stack, opts, swig) {
