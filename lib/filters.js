 ...
 *
 * @param  {mixed}  input
 * @return {mixed}        Backslash-escaped string.
 */
 ...
 *
 * @param  {mixed}  input
 * @return {mixed}        Returns the same object as the input, but with all string values stripped of tags.
 */
 ...
 *
 * @param  {mixed}  input
 * @return {mixed}        Returns the same object as the input, but with all words in strings title-cased.
 */
 ...
 *
 * @param  {mixed}  input
 * @return {mixed}        Returns the same type as the input, with all strings upper-cased.
 */
