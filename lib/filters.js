...
function iterateFilter(input) {
  ...
  if (typeof input === 'object') {
    utils.each(input, function eachInput(value, key) {
 ...
 */
exports.addslashes = function addslashesFilter(input) {
 ...
 */
exports.capitalize = function capitalizeFilter(input) {
 ...
 */
exports.date = function dateFilter(input, format, offset, abbr) {
  var l = format.length,
 ...
 */
exports["default"] = function defaultFilter(input, def) {
 ...
 */
exports.escape = function escapeFilter(input, type) {
 ...
 */
exports.first = function firstFilter(input) {
 ...
 */
exports.groupBy = function groupByFilter(input, key) {
  if (!utils.isArray(input)) {
    return input;
  }
  ...
  utils.each(input, function eachInput(value) {
 ...
 * @return {string}
 */
exports.join = function joinFilter(input, glue) {
  if (utils.isArray(input)) {
 ...
 */
exports.json = function jsonFilter(input, indent) {
 ...
 */
exports.last = function lastFilter(input) {
  if (typeof input === 'object' && !utils.isArray(input)) {
    var keys = utils.keys(input);
 ...
 */
exports.length = function lengthFilter(input) {
  if (typeof input === 'object' && !utils.isArray(input)) {
    var keys = utils.keys(input);
    return keys.length;
  }
 ...
 * @return {*}          Returns the same type as the input.
 */
exports.lower = function lowerFilter(input) {
 ...
 */
exports.raw = function rawFilter(input) {
 ...
 */
exports.replace = function replaceFilter(input, search, replacement, flags) {
 ...
 */
exports.reverse = function reverseFilter(input) {
 ...
 */
exports.safe = function safeFilter(input) {
 ...
 * @return {*}        Sorted array;
 */
exports.sort = function sortFilter(input, reverse) {
  var out, clone;
  if (utils.isArray(input)) {
 ...
 */
exports.striptags = function striptagsFilter(input) {
 ...
 */
exports.title = function titleFilter(input) {
 ...
 */
exports.uniq = function uniqFilter(input) {
  var result;
  ...
  result = [];
  utils.each(input, function eachInput(v) {
 ...
 */
exports.upper = function upperFilter(input) {
 ...
 */
exports.url_encode = function url_encodeFilter(input) {
 ...
 */
exports.url_decode = function url_decodeFilter(input) {
