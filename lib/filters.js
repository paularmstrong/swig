 ...
 */
exports.capitalize = function capitalize(input) {
 ...
 */
exports.date = function date(input, format, offset, abbr) {
  var l = format.length,
 ...
 */
exports.escape = function escape(input, type) {
 ...
 */
exports.first = function first(input) {
 ...
 */
exports.groupBy = function groupBy(input, key) {
  if (!utils.isArray(input)) {
    return input;
  }
 ...
 * @return {string}
 */
exports.join = function join(input, glue) {
  if (utils.isArray(input)) {
 ...
 */
exports.json = function json(input, indent) {
 ...
 */
exports.last = function last(input) {
  if (typeof input === 'object' && !utils.isArray(input)) {
    var keys = utils.keys(input);
 ...
 */
exports.length = function length(input) {
  if (typeof input === 'object' && !utils.isArray(input)) {
    var keys = utils.keys(input);
    return keys.length;
  }
 ...
 * @return {*}          Returns the same type as the input.
 */
exports.lower = function lower(input) {
 ...
 */
exports.raw = function raw(input) {
 ...
 */
exports.replace = function replace(input, search, replacement, flags) {
 ...
 */
exports.reverse = function reverse(input) {
 ...
 */
exports.safe = function safe(input) {
 ...
 * @return {*}        Sorted array;
 */
exports.sort = function sort(input, reverse) {
  var out, clone;
  if (utils.isArray(input)) {
 ...
 */
exports.striptags = function striptags(input) {
 ...
 */
exports.title = function title(input) {
 ...
 */
exports.uniq = function uniq(input) {
  var result;
 ...
 */
exports.upper = function upper(input) {
 ...
 */
exports.url_encode = function url_encode(input) {
 ...
 */
exports.url_decode = function url_decode(input) {
