...
/**
 * JSON-parser a string. If an string under object format is passed, all values will be object json.
 *
 * @example
 * // my_str = '{"key":"value"}';
 * {{ my_str|json_parser }}
 ...
 *
 * @param  {*} input
 * @return {*}       JSON-parser string.
 */
exports.json_parser = function (input) {
  if (!input) return {};
