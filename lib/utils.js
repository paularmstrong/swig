...
/**
 * Replaces each individual Carriage-Return or Line-Feed character with an escaped Line-Feed.
 * @param {string} str The input string to escape.
 * @return {string} Escaped input.
 */
exports.escapeLineEndings = function (str) {
  return str.replace(/\n|\r/g, '\\n');
};

/**
 * Replaces each Carriage-Return+Line-Feed with an escaped Carriage-Return+Line-Feed and
 * each individual Carriage-Return or Line-Feed character with an escaped Line-Feed.
 * @param {string} str The input string to escape.
 * @return {string} Escaped input.
 */
exports.escapeLineEndingsAllowCR = function (str) {
  return str.replace(/\r\n/g, '\\r\\n').replace(/[^\r]\n|\r[^\n]/g, '\\n');
};
