...
describe('Filter', function () {
  ...
  describe('date with global offset', function () {
    ...
    it('should return as same time in CDT, relative to PDT', function () {
      '10:20:10'.should.eql(swig.compile('{{ d|date("H:i:s") }}')({ d: date }));
      '12:20:10'.should.eql(swig.compile('{{ d|date("H:i:s", 300) }}')({ d: date }));
      '20:40:10'.should.eql(swig.compile('{{ d|date("H:i:s", -200) }}')({ d: date }));
    });
  });
